...
public class MongoClientLesson extends AbstractLesson {
  ...
  //private String uri = "mongodb+srv://m220student:ajju123@mflix-shard-00-00-qdyem.mongodb.net:27017/admin?retryWrites=true";

   private String uri ="mongodb://m220student:ajju123@mflix-shard-00-00-qdyem.mongodb.net:27017,mflix-shard-00-01-qdyem.mongodb.net:27017,mflix-shard-00-02-qdyem.mongodb.net:27017/test?ssl=true&replicaSet=mflix-shard-0&authSource=admin&retryWrites=true";

   //private String uri ="mongodb://m220student:ajju123@mflix-shard-00-00-qdyem.mongodb.net:27017,mflix-shard-00-01-qdyem.mongodb.net:27017,mflix-shard-00-02-qdyem.mongodb.net:27017/admin?ssl=true&replicaSet=mflix-shard-0&authSource=admin";
  // should work -
  // private String uri ="mongo mongodb+srv://m220student:ajju123@mflix-qdyem.mongodb.net/test?retryWrites=true";
